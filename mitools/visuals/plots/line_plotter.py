...
class LinePlotter:
    ...
    def save_plot(
        ...
        if self.figure or draw:
            ...
            try:
                ...
                raise LinePlotterException(f"Error while saving line plot: {e}")
        else:
            raise LinePlotterException("Plot not drawn yet. Call draw() before saving.")
        return self
    ...
    @classmethod
    def from_json(cls, file_path: Union[str, Path]) -> "LinePlotter":
